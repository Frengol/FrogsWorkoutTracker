...
export type DashboardSnapshot = {
  ...
  recentPrs: (WorkoutRecord & { exerciseName: string })[];
...
export type ImportReviewGroupStatus = 'pending' | 'replaced' | 'edited';
...
export type ImportReview = {
  importJobId: string;
  sourceType: Extract<ImportSourceType, 'hevy_csv' | 'frog_workouts_csv' | 'frog_routine_json'>;
  fileName: string;
  status: ImportJobStatus;
  insertedCount: number;
  skippedCount: number;
