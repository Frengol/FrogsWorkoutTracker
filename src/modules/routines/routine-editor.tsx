...
export const RoutineEditor = ({ routineId }: { routineId?: string }) => {
  ...
  const routineEditorContextIdRef = useRef(routineId ? `routine-editor:${routineId}` : 'routine-editor:new');
  ...
  useEffect(() => {
    recordDiagnosticAction('routine-editor', 'open-routine-editor', { editing: Boolean(routineId) });
  }, [routineId]);
  ...
  const searchResults = listExercises({ search: exerciseSearch, limit: 12 });
  ...
  const addExercise = useCallback((exerciseId: string, exerciseName: string, muscleGroup: MuscleGroup, equipment: Equipment) => {
  ...
  useFocusEffect(
    useCallback(() => {
      ...
      const pendingExerciseId = consumePendingExerciseSelection(routineEditorContextIdRef.current);
      ...
      if (exercise) {
        addExercise(exercise.id, exercise.name, exercise.muscleGroup, exercise.equipment);
      }
    }, [addExercise]),
  );
  ...
  const getRoutineFieldFocusProps = useCallback(
    (fieldId: string) => ({
      inputRef: registerFocusable(fieldId),
      onFocus: () => revealFocusable(fieldId),
      onLayout: registerFocusableLayout(fieldId),
    }),
    [registerFocusable, registerFocusableLayout, revealFocusable],
  );
    ...
    <AppScreen
        ...
        <Controller
          ...
          render={({ field: { value, onChange } }) => (
            <Field
              ...
              {...getRoutineFieldFocusProps('routine-name')}
        ...
        <Controller
          ...
          render={({ field: { value, onChange } }) => (
            <Field
              ...
              value={value}
              onChangeText={onChange}
              {...getRoutineFieldFocusProps('routine-description')}
        ...
        <View style={styles.folderFieldGroup} testID="group-routine-editor-folder">
          ...
          {isCreatingNewFolder ? (
            <Field
              ...
              {...getRoutineFieldFocusProps('routine-folder-new')}
      ...
      <Card>
        <Field
          ...
          {...getRoutineFieldFocusProps('routine-search')}
          placeholder="Digite aqui o exercício desejado"
            ...
            onPress={() => {
              ...
              router.push(
                routes.exercises.custom({
                  ...
                  contextId: routineEditorContextIdRef.current,
                }),
              );
            }}
            style={{ flex: 1 }}
              ...
              <>
                <View style={styles.row}>
                  {cardioMachine ? (
                    <Field
                      ...
                      {...getRoutineFieldFocusProps(`routine-cardio-speed-${exercise.localId}`)}
                      onChangeText={(value) => {
                  ...
                  <Field
                    ...
                    {...getRoutineFieldFocusProps(`routine-cardio-duration-${exercise.localId}`)}
                    onChangeText={(value) =>
                      setSelectedExercises((current) =>
                        current.map((item) =>
                          item.localId === exercise.localId
                ...
                <View style={styles.row}>
                  <Field
                    ...
                    {...getRoutineFieldFocusProps(`routine-cardio-distance-${exercise.localId}`)}
                    onChangeText={(value) => {
                  ...
                  {cardioMachine ? (
                    <Field
                      ...
                      {...getRoutineFieldFocusProps(`routine-cardio-elevation-${exercise.localId}`)}
                      onChangeText={(value) => {
                        const sanitizedValue = normalizeDecimalInput(value);
                        setSelectedExercises((current) =>
                          current.map((item) =>
                ...
                <Field
                  ...
                  value={exercise.note}
                  {...getRoutineFieldFocusProps(`routine-note-${exercise.localId}`)}
                  onChangeText={(value) =>
                    setSelectedExercises((current) =>
              ...
              <>
                <View style={styles.row}>
                  <Field
                    ...
                    {...getRoutineFieldFocusProps(`routine-sets-${exercise.localId}`)}
                    onChangeText={(value) => {
                  ...
                  <Field
                    ...
                    {...getRoutineFieldFocusProps(`routine-target-${exercise.localId}`)}
                    onChangeText={(value) =>
                      setSelectedExercises((current) =>
                        current.map((item) =>
                  ...
                  <Field
                    ...
                    {...getRoutineFieldFocusProps(`routine-rest-${exercise.localId}`)}
                    onChangeText={(value) => {
                      const sanitizedValue = normalizeNumericInput(value);
                      setSelectedExercises((current) =>
                        current.map((item) =>
                ...
                <View style={styles.row}>
                  <Field
                    ...
                    {...getRoutineFieldFocusProps(`routine-link-${exercise.localId}`)}
                    onChangeText={(value) =>
                      setSelectedExercises((current) =>
                        current.map((item) =>
                  ...
                  <Field
                    ...
                    {...getRoutineFieldFocusProps(`routine-superset-${exercise.localId}`)}
                    onChangeText={(value) =>
                      setSelectedExercises((current) =>
                        current.map((item) =>
